...
def generate_launch_description():
    rviz_config_dir = os.path.join(
        get_package_share_directory("neuronbot2_description"), "rviz", "urdf.rviz"
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "use_camera", default_value="none", description="Use camera?"
            ),
            ExecuteProcess(
                cmd=[
                    "gzserver",
            ...
            ExecuteProcess(
                cmd=[
                    ...
                    "spawn_entity.py",
                    "-file",
                    gazebo_model_path + "/neuronbot2/" + "model.sdf",
                    "-entity",
                    "nb2",
                ...
                condition=IfCondition(
                    PythonExpression(['"', use_camera, '" == "none"'])
                ),
                output="screen",
            ),
            ExecuteProcess(
                cmd=[
                    ...
                    "spawn_entity.py",
                    "-file",
                    gazebo_model_path + "/neuronbot2_w_front_camera/" + "model.sdf",
                    "-entity",
                    "nb2",
                    "-spawn_service_timeout",
                    "300",
                ...
                condition=IfCondition(
                    PythonExpression(['"', use_camera, '" == "front"'])
                ),
                output="screen",
            ),
            ExecuteProcess(
                cmd=[
                    ...
                    "spawn_entity.py",
                    "-file",
                    gazebo_model_path + "/neuronbot2_w_top_camera/" + "model.sdf",
                    "-entity",
                    "nb2",
                    "-spawn_service_timeout",
                    "300",
                ...
                condition=IfCondition(
                    PythonExpression(['"', use_camera, '" == "top"'])
                ),
                output="screen",
            ),
            ExecuteProcess(
